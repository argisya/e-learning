        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border overflow-hidden">
            <form action="" method="POST" enctype="multipart/form-data" novalidate id="createForm" class="p-6 lg:p-8">
                ...
                <div class="mb-8 pb-8 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="contoh@email.com" class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all">
                        </div>
                ...
                <div class="mb-8 pb-8 border-b">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="nomenklatur" name="nomenklatur" value="{{ old('nomenklatur') }}" placeholder="Contoh: Guru Matematika" class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_sk_jabatan" name="tanggal_sk_jabatan" value="{{ old('tanggal_sk_jabatan') }}" class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all">
                        </div>
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 pt-6 border-t">
                    <a href="" class="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium">
