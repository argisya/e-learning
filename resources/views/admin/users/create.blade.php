...
<div class="min-h-screen py-8 px-4">
    ...
    <div class="max-w-3xl mx-auto mb-8 flex items-center justify-between">
        ...
        <a href="{{ route('users.index') }}" class="inline-flex items-center gap-2 text-gray-600 hover:text-primary-600 transition-colors">
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-sm border overflow-hidden">
        <form action="{{ route('users.store') }}" method="POST" novalidate id="createForm" class="p-6 lg:p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            ...
                            <!-- Role Staff -->
                            <label class="relative cursor-pointer">
                                <input type="radio" name="role" value="staff" {{ old('role') === 'staff' ? 'checked' : '' }} required onchange="showAdditionalFields(this.value)">
                                <div class="p-4 border-2 border-gray-200 rounded-lg hover:border-primary-500 hover:bg-primary-50 transition-all group">
                                    <div class="w-10 h-10 rounded-lg bg-yellow-100 flex items-center justify-center mb-2 group-hover:bg-yellow-500 group-hover:text-white transition-colors">
                                        <i class="fas fa-user-tag text-yellow-600 text-lg group-hover:text-white"></i>
                                    </div>
...
Tim E-Learning</textarea>
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 pt-6 border-t">
                    <a href="{{ route('users.index') }}" class="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium">
