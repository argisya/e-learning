                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="username" name="username" value="{{ old('username', strtolower(explode(' ', old('nama_lengkap', $class->nama_kelas ?? '') )[0])) }}" placeholder="Username login" required autocomplete="off" class="w-full pl-10 pr-4 py-2.5 border-2 border-gray-200 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all">
                            </div>
                            <p class="text-xs text-gray-500 mt-1">Min. 6 karakter, hanya huruf dan angka</p>
